...
import syncWebSocketDeviceStateToIHost from "../../../webSocket/syncWebSocketDeviceStateToIHost";
import logger from "../../../../log";

export default async function updateWanDeviceStates(req: Request, lanState: any) {
